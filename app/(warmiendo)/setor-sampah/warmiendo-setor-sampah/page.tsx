...
export default function WarmiendoSetorSampah() {
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-2xl font-bold text-neutral-900">
              Setor Sampah Warmiendo
            </h1>
            <p className="text-sm text-neutral-500">
              Input data setoran sampah Anda dan dapatkan kredit saldo via
              ekspedisi
            </p>
          </div>
        </div>
