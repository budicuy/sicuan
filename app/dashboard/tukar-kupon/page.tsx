      ...
      <div className="flex border-b border-neutral-200 bg-neutral-100/60 p-1 rounded-xl w-fit gap-1">
        ...
        >
          ...
          {history.filter((h) => h.status === "aktif").length > 0 && (
            <span className="absolute -top-1.5 -right-1.5 bg-red-600 text-white font-bold rounded-full w-5 h-5 flex items-center justify-center text-[9px] border border-white shadow-sm animate-bounce">
