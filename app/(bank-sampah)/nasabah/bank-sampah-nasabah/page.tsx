...
import {
  ...
  getNasabah,
  updateNasabah,
} from "@/app/(bank-sampah)/nasabah/bank-sampah-nasabah/action";
...
export default function BankSampahNasabahPage() {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-neutral-200 pb-5">
        <div>
          ...
          <p className="text-sm text-neutral-500 mt-1">
            Kelola profil nasabah Bank Sampah Anda, termasuk nomor identitas
            (NIK), nomor telepon, alamat, dan nomor rekening penampung reward.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-neutral-200 rounded-lg text-sm bg-white focus:outline-none focus:border-primary-600 focus:ring-2 focus:ring-primary-600/10 transition-all uppercase text-neutral-850"
            />
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 border border-neutral-200 rounded-lg text-sm bg-white focus:outline-none focus:border-primary-600 focus:ring-2 focus:ring-primary-600/10 transition-all resize-none text-neutral-850"
          />
          {formErrors.alamat && (
