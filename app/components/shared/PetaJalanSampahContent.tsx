...
export function PetaJalanSampahContent({
  ...
  const [sumber, setSumber] = useState<SumberType>(() => {
    ...
    if (role === "warmiendo") return "warmindo";
    return "rumah_tangga";
  });
  const [kelola, setKelola] = useState<KelolaType>(() => {
    if (role === "bank-sampah") return "bank_sampah";
    return "bank_sampah";
  });
  const [pengelolaan, setPengelolaan] =
    useState<PengelolaanType>("pilah_timbang");
    ...
    <div className="space-y-6 pb-4 animate-in fade-in duration-350">
      ...
      <div className="bg-white p-6 rounded-2xl border border-neutral-200 shadow-xs flex flex-col md:flex-row justify-between items-start md:items-center gap-4 relative overflow-hidden">
        ...
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-primary-600 text-white flex items-center justify-center shadow-lg shadow-primary-600/25 shrink-0">
            ...
            <div className="bg-neutral-50/50 rounded-xl border border-neutral-200 p-6 space-y-6 animate-in slide-in-from-top-4 duration-300">
              ...
              {activeStep === 1 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {(Object.keys(sumberOptions) as SumberType[]).map((key) => {
              ...
              {activeStep === 2 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {(Object.keys(kelolaOptions) as KelolaType[]).map((key) => {
              ...
              {activeStep === 3 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {(Object.keys(pengelolaanOptions) as PengelolaanType[]).map(
                      (key) => {
              ...
              {activeStep === 4 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {(Object.keys(tujuanOptions) as TujuanType[]).map((key) => {
