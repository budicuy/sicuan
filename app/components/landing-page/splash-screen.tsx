...
export function SplashScreen() {
  ...
  const letters = Array.from("SICUAN");
  ...
  return (
    <motion.div
      key="splash"
      className="fixed inset-0 z-100 flex flex-col items-center justify-center bg-[radial-gradient(circle_at_center,var(--color-primary-950)_0%,#030e06_100%)] text-white select-none overflow-hidden"
