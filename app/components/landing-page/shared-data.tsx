...
export const MINI_CARDS: MiniCardData[] = [
  {
    ...
    trend: "+12.4% bln ini",
    icon: UtensilsIcon,
    cardBg: "bg-linear-to-br from-emerald-600 to-teal-900",
  ...
  },
  {
    ...
    trend: "Gold Tier 🥇",
    icon: Award,
    cardBg: "bg-linear-to-br from-amber-500 to-orange-800",
    cardBorder: "border-white/20 hover:border-white/40",
    iconColor: "text-white",
    iconBg: "bg-white/10 border-white/10",
    glowColor: "from-white/10",
  ...
  },
  {
    ...
    trend: "Efisiensi 94%",
    icon: Leaf,
    cardBg: "bg-linear-to-br from-green-500 to-emerald-900",
    cardBorder: "border-white/20 hover:border-white/40",
    iconColor: "text-white",
    iconBg: "bg-white/10 border-white/10",
    glowColor: "from-white/10",
  ...
  },
  {
    ...
    icon: Truck,
    cardBg: "bg-linear-to-br from-blue-500 to-indigo-900",
    cardBorder: "border-white/20 hover:border-white/40",
    iconColor: "text-white",
    iconBg: "bg-white/10 border-white/10",
    glowColor: "from-white/10",
  ...
  },
  {
    ...
    trend: "Terverifikasi",
    icon: CheckCircle,
    cardBg: "bg-linear-to-br from-teal-500 to-cyan-900",
    cardBorder: "border-white/20 hover:border-white/40",
    iconColor: "text-white",
    iconBg: "bg-white/10 border-white/10",
    glowColor: "from-white/10",
  ...
  },
  {
    ...
    icon: Gift,
    cardBg: "bg-linear-to-br from-rose-500 to-pink-900",
    cardBorder: "border-white/20 hover:border-white/40",
    iconColor: "text-white",
    iconBg: "bg-white/10 border-white/10",
    glowColor: "from-white/10",
  ...
  },
  {
    ...
    trend: "+18.7% bln lalu",
    icon: TrendingUp,
    cardBg: "bg-linear-to-br from-lime-500 to-green-900",
    cardBorder: "border-white/20 hover:border-white/40",
    iconColor: "text-white",
    iconBg: "bg-white/10 border-white/10",
    glowColor: "from-white/10",
  ...
  },
  {
    ...
    trend: "Aktif Setor",
    icon: User,
    cardBg: "bg-linear-to-br from-violet-500 to-purple-900",
    cardBorder: "border-white/20 hover:border-white/40",
    iconColor: "text-white",
    iconBg: "bg-white/10 border-white/10",
    glowColor: "from-white/10",
  ...
  },
  {
    ...
    icon: Coins,
    cardBg: "bg-linear-to-br from-fuchsia-500 to-pink-950",
    cardBorder: "border-white/20 hover:border-white/40",
    iconColor: "text-white",
    iconBg: "bg-white/10 border-white/10",
    glowColor: "from-white/10",
