        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-neutral-900/40 backdrop-blur-xs p-4 animate-in fade-in duration-200">
          <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl border border-neutral-100 p-6 relative animate-in zoom-in-95 duration-200 space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                <label
                  htmlFor="edit-setor-berat-b"
                  className="block text-xs font-bold text-neutral-700 mb-1"
                >
                  Berat (kg)
                </label>
                <input
                  id="edit-setor-berat-b"
                  type="number"
                  step="0.01"
              ...
              <div>
                <label
                  htmlFor="edit-setor-tanggal-b"
                  className="block text-xs font-bold text-neutral-700 mb-1"
                >
                  Tanggal Setor
                </label>
                <input
                  id="edit-setor-tanggal-b"
                  type="date"
              ...
              <div>
                <label
                  htmlFor="edit-setor-status-b"
                  className="block text-xs font-bold text-neutral-700 mb-1"
                >
                  Status
                </label>
                <select
                  id="edit-setor-status-b"
              ...
              <div>
                <label
                  htmlFor="edit-setor-foto-tambahan-b"
                  className="block text-xs font-bold text-neutral-700 mb-1"
                >
                  Foto Tambahan
                </label>
              ...
              <div>
                <label
                  htmlFor="edit-setor-catatan-b"
                  className="block text-xs font-bold text-neutral-700 mb-1"
                >
                  Catatan
                </label>
                <textarea
                  id="edit-setor-catatan-b"
