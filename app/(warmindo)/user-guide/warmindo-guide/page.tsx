...
export default function WarmindoGuidePage() {
  ...
  const sections: GuideSection[] = [
    {
      id: "intro",
      title: "Pendahuluan",
      subtitle: "Peran & kemitraan Warmindo",
      icon: BookOpen,
    },
    {
      id: "setor",
  ...
  const faqs = [
    {
      q: "Mengapa Warmindo tidak mendapatkan Poin Sirkular seperti nasabah Konsumen?",
      a: "Program kemitraan Warmindo dirancang khusus untuk memberikan insentif ekonomi produktif secara langsung. Seluruh hasil setoran sampah Anda dikonversi menjadi Kredit Rupiah (saldo kas) yang dapat langsung dicairkan sebagai dana segar untuk mendukung perputaran modal usaha Anda.",
    },
    {
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4 animate-in fade-in duration-200">
                <div className="border-b border-neutral-150 pb-3">
                  ...
                  <p className="text-xs text-neutral-500">
                    Peran strategis Warmindo dalam ekosistem sirkular.
                  </p>
                </div>
                <p className="text-xs text-neutral-600 leading-relaxed">
                  Warmindo adalah salah satu pilar utama dalam menyerap kembali
            ...
            {activeSection === "credit" && (
              <div className="space-y-4 animate-in fade-in duration-200">
                ...
                <p className="text-xs text-neutral-600 leading-relaxed">
                  Berbeda dari nasabah perorangan, Warmindo{" "}
